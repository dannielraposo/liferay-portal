...
export class ObjectViewApi {
	...
	set defaultHeaders(defaultHeaders: any) {
		...
		public async deleteObjectView(
			...
			const localVarPath = this._basePath + '/object-admin/v1.0/object-views/{objectViewId}'
		...
		public async getObjectDefinitionByExternalReferenceCodeObjectViewsPage(
			...
			const localVarPath = this._basePath + '/object-admin/v1.0/object-definitions/by-external-reference-code/{externalReferenceCode}/object-views'
		...
		public async getObjectDefinitionObjectViewsPage(
			...
			const localVarPath = this._basePath + '/object-admin/v1.0/object-definitions/{objectDefinitionId}/object-views'
		...
		public async postObjectViewCopy(
			...
			const localVarPath = this._basePath + '/object-admin/v1.0/object-views/{objectViewId}/copy'
						.replace('{objectViewId}',encodeURIComponent(objectViewId))
				;
