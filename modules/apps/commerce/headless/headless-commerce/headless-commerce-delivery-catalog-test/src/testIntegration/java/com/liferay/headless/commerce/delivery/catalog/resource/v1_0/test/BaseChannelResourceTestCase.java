...
public abstract class BaseChannelResourceTestCase {
	...
	public void testGraphQLGetChannelsPage() throws Exception {
		...
		Channel channel1 = testGraphQLGetChannelsPageChannel_addChannel(
			randomChannel());

		Channel channel2 = testGraphQLGetChannelsPageChannel_addChannel(
			randomChannel());
	...
	protected Channel testGraphQLGetChannelsPageChannel_addChannel(
			Channel channel)
		throws Exception {
