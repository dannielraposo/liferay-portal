...
public class PreviewPortletDataHandlerUtil {
	...
	public static Map<String, List<PreviewPortletDataHandler>>
			getPreviewPortletDataHandlersMap(
				...
				Group group, Locale locale, long plid,
				PortletDataContextFactory portletDataContextFactory,
				PortletDataHandlerProvider portletDataHandlerProvider,
				Function<Portlet, DateRange> portletDateRangeFunction,
				List<Portlet> portlets, boolean portletScoped, String range)
		throws Exception {
		...
		for (Portlet portlet : portlets) {
			...
			DateRange dateRange = portletDateRangeFunction.apply(portlet);
			...
			PortletDataContext portletDataContext =
				portletDataContextFactory.createPreparePortletDataContext(
					group.getCompanyId(), group.getGroupId(), range, startDate,
					endDate);
					...
					PortletDataContext privatePortletDataContext =
						portletDataContextFactory.
							createPreparePortletDataContext(
								group.getCompanyId(), group.getGroupId(), range,
								startDate, endDate);
