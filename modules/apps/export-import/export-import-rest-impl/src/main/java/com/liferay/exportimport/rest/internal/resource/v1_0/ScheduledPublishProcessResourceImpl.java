...
@Component(
	...
	scope = ServiceScope.PROTOTYPE, service = ScheduledPublishProcessResource.class
)
public class ScheduledPublishProcessResourceImpl extends BaseScheduledPublishProcessResourceImpl {
}