	...
	public static Map<String, String[]> putDateRangeParameters(
		...
		if (dateRangeType == null) {
			if ((endDate == null) && (startDate == null)) {
				dateRangeType = DateRangeUtil.DATE_RANGE_TYPE_ALL;
			}
			else {
				dateRangeType = DateRangeUtil.DATE_RANGE_TYPE_DATE_RANGE;
			}
		}

		if (dateRangeType.equals(DateRangeUtil.DATE_RANGE_TYPE_ALL)) {
			parameterMap.put(
		...
		if (dateRangeType.equals(DateRangeUtil.DATE_RANGE_TYPE_LAST)) {
			if (startDate == null) {
