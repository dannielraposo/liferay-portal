...
public abstract class BaseScheduledPublishProcessResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		scheduledPublishProcess.setJobName(regex);
		...
		Assert.assertEquals(regex, scheduledPublishProcess.getJobName());
	...
	protected void assertValid(ScheduledPublishProcess scheduledPublishProcess)
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("jobName", additionalAssertFieldName)) {
				if (scheduledPublishProcess.getJobName() == null) {
					valid = false;
				}
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("jobName", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						scheduledPublishProcess1.getJobName(),
						scheduledPublishProcess2.getJobName())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("jobName")) {
			Object object = scheduledPublishProcess.getJobName();
		...
		return new ScheduledPublishProcess() {
			{
				...
				jobName = StringUtil.toLowerCase(RandomTestUtil.randomString());
...
// LIFERAY-REST-BUILDER-HASH:948788023