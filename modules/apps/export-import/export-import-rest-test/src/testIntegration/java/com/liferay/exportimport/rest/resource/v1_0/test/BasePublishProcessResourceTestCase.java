...
public abstract class BasePublishProcessResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		publishProcess.setJobName(regex);
		...
		Assert.assertEquals(regex, publishProcess.getJobName());
	...
	protected void assertValid(PublishProcess publishProcess) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("jobName", additionalAssertFieldName)) {
				if (publishProcess.getJobName() == null) {
					valid = false;
				}
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("jobName", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						publishProcess1.getJobName(),
						publishProcess2.getJobName())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("jobName")) {
			Object object = publishProcess.getJobName();
...
// LIFERAY-REST-BUILDER-HASH:-741768939