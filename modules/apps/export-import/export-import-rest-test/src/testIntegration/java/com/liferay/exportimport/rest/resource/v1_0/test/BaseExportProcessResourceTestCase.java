...
public abstract class BaseExportProcessResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		Assert.assertEquals(regex, exportProcess.getTitle());
	}
	...
	protected void assertValid(ExportProcess exportProcess) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("title", additionalAssertFieldName)) {
				if (exportProcess.getTitle() == null) {
					valid = false;
				}
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("title", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						exportProcess1.getTitle(), exportProcess2.getTitle())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("title")) {
			Object object = exportProcess.getTitle();
...
// LIFERAY-REST-BUILDER-HASH:43142117