...
public class RequestPortletDataHandler implements Serializable {
	...
	public Long[] getLayoutIds() {
		if (_layoutIdsSupplier != null) {
			layoutIds = _layoutIdsSupplier.get();

			_layoutIdsSupplier = null;
		}
	...
	public void setLayoutIds(
		UnsafeSupplier<Long[], Exception> layoutIdsUnsafeSupplier) {

		_layoutIdsSupplier = () -> {
			try {
				return layoutIdsUnsafeSupplier.get();
			}
	...
	protected Long[] layoutIds;

	@JsonIgnore
	private Supplier<Long[]> _layoutIdsSupplier;
	...
	public String toString() {
		...
		if (layoutIds != null) {
			...
			for (int i = 0; i < layoutIds.length; i++) {
				sb.append(layoutIds[i]);

				if ((i + 1) < layoutIds.length) {
					sb.append(", ");
				}
			}
...
// LIFERAY-REST-BUILDER-HASH:-1542545464