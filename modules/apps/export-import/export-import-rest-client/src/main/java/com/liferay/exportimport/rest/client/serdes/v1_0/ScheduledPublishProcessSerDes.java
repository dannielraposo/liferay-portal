...
public class ScheduledPublishProcessSerDes {
	...
	public static String toJSON(
		...
		if (scheduledPublishProcess.getJobName() != null) {
			...
			sb.append(_escape(scheduledPublishProcess.getJobName()));
	...
	public static Map<String, String> toMap(
		...
		if (scheduledPublishProcess.getJobName() == null) {
			...
			map.put(
				"jobName",
				String.valueOf(scheduledPublishProcess.getJobName()));
		}
	...
	public static class ScheduledPublishProcessJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "creator")) {
				...
				if (jsonParserFieldValue != null) {
					scheduledPublishProcess.setJobName(
						(String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "name")) {
...
// LIFERAY-REST-BUILDER-HASH:26841929