...
public class RequestPortletDataHandlerSerDes {
	...
	public static String toJSON(
		...
		if (requestPortletDataHandler.getLayoutIds() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			for (int i = 0; i < requestPortletDataHandler.getLayoutIds().length;
				 i++) {

				sb.append(requestPortletDataHandler.getLayoutIds()[i]);

				if ((i + 1) < requestPortletDataHandler.getLayoutIds().length) {
					sb.append(", ");
				}
			}
		...
		if (requestPortletDataHandler.getPrivateLayout() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(requestPortletDataHandler.getPrivateLayout());
		}
	...
	public static Map<String, String> toMap(
		...
		if (requestPortletDataHandler.getLayoutIds() == null) {
			map.put("layoutIds", null);
		}
		else {
			map.put(
				"layoutIds",
				String.valueOf(requestPortletDataHandler.getLayoutIds()));
		}
		...
		if (requestPortletDataHandler.getPrivateLayout() == null) {
			...
			map.put(
				"privateLayout",
				String.valueOf(requestPortletDataHandler.getPrivateLayout()));
		}
	...
	public static class RequestPortletDataHandlerJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(jsonParserFieldName, "layoutIds")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "layoutIds")) {
				if (jsonParserFieldValue != null) {
					requestPortletDataHandler.setLayoutIds(
				...
				if (jsonParserFieldValue != null) {
					requestPortletDataHandler.setPrivateLayout(
...
// LIFERAY-REST-BUILDER-HASH:-1841655348