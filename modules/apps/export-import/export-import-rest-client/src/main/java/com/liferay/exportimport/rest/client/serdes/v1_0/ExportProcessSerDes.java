...
public class ExportProcessSerDes {
	...
	public static String toJSON(ExportProcess exportProcess) {
		...
		if (exportProcess.getTitle() != null) {
			...
			sb.append(_escape(exportProcess.getTitle()));
	...
	public static Map<String, String> toMap(ExportProcess exportProcess) {
		...
		if (exportProcess.getTitle() == null) {
			...
			map.put("title", String.valueOf(exportProcess.getTitle()));
		}
	...
	public static class ExportProcessJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "creator")) {
				...
				if (jsonParserFieldValue != null) {
					exportProcess.setTitle((String)jsonParserFieldValue);
				}
			}
		}
...
// LIFERAY-REST-BUILDER-HASH:1378630611