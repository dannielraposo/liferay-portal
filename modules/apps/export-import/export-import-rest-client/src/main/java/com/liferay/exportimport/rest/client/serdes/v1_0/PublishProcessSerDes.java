...
public class PublishProcessSerDes {
	...
	public static String toJSON(PublishProcess publishProcess) {
		...
		if (publishProcess.getJobName() != null) {
			...
			sb.append(_escape(publishProcess.getJobName()));
		...
		if (publishProcess.getType() != null) {
			...
			sb.append(String.valueOf(publishProcess.getType()));
		}
	...
	public static Map<String, String> toMap(PublishProcess publishProcess) {
		...
		if (publishProcess.getJobName() == null) {
			...
			map.put("jobName", String.valueOf(publishProcess.getJobName()));
		}
	...
	public static class PublishProcessJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			...
			else if (Objects.equals(jsonParserFieldName, "jobName")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "creator")) {
				...
				if (jsonParserFieldValue != null) {
					publishProcess.setJobName((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "name")) {
				if (jsonParserFieldValue != null) {
...
// LIFERAY-REST-BUILDER-HASH:-416454461