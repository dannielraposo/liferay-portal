 ...
 */
	...
	/**
	* A fragment editable element of type text.
	*/
	export class TextFragmentEditableElementValue extends FragmentEditableElementValue {
	...
	static "attributeTypeMap": Array<{
		...
		static getAttributeTypeMap() {
				return super.getAttributeTypeMap().concat(TextFragmentEditableElementValue.attributeTypeMap);
		}
	}
