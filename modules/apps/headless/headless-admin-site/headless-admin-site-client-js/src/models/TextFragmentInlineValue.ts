 ...
 */
	...
	/**
	* An inline value of a fragment text element.
	*/
	export class TextFragmentInlineValue extends TextFragmentValue {
	...
	static "attributeTypeMap": Array<{
		...
		static getAttributeTypeMap() {
				return super.getAttributeTypeMap().concat(TextFragmentInlineValue.attributeTypeMap);
		}
	}
