 ...
 */
	...
	/**
	* A mapped background image value.
	*/
	export class MappedBackgroundImageValue extends BackgroundImageValue {
	...
	static "attributeTypeMap": Array<{
		...
		static getAttributeTypeMap() {
				return super.getAttributeTypeMap().concat(MappedBackgroundImageValue.attributeTypeMap);
		}
	}
