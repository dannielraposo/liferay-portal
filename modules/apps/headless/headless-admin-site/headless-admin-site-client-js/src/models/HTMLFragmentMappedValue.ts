 ...
 */
	...
	/**
	* A mapped value of a fragment HTML element.
	*/
	export class HTMLFragmentMappedValue extends HTMLFragmentValue {
	...
	static "attributeTypeMap": Array<{
		...
		static getAttributeTypeMap() {
				return super.getAttributeTypeMap().concat(HTMLFragmentMappedValue.attributeTypeMap);
		}
	}
