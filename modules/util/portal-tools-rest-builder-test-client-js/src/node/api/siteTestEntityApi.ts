...
export class SiteTestEntityApi {
	...
	set defaultHeaders(defaultHeaders: any) {
		...
		public async getSiteSiteTestEntitiesPage(
			...
			const localVarPath = this._basePath + '/test/v1.0/sites/{siteId}/site-test-entities'
		...
		public async getSiteSiteTestEntityByExternalReferenceCode(
			...
			const localVarPath = this._basePath + '/test/v1.0/sites/{siteId}/site-test-entities/by-external-reference-code/{externalReferenceCode}'
		...
		public async getSiteTestEntity(
			...
			const localVarPath = this._basePath + '/test/v1.0/site-test-entities/{siteTestEntityId}'
		...
		public async getSiteTestEntityPermissionsPage(
			...
			const localVarPath = this._basePath + '/test/v1.0/site-test-entities/{siteTestEntityId}/permissions'
						.replace('{siteTestEntityId}',encodeURIComponent(siteTestEntityId))
								;
